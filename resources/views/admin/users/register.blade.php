    ...
    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
      <g id="Icon" transform="translate(27.000000, 15.000000)">
        ...
        <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
          ...
          <form id="formAuthentication" class="mb-3" action="{{Route('user-home')}}" method="POST">
            @csrf
            <div class="mb-3">
              <label for="username" class="form-label">fullname</label>
              <input type="text" class="form-control"  value="{{old('user_fullname')}}" name="user_fullname" placeholder="Enter your username" autofocus>
            </div>
            @error('user_fullname')
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control"value="{{old('user_email')}}"  name="user_email" placeholder="Enter your email">
            </div>
            @error('user_email')
              <span class="alert alert-danger">{{ $message}}</span>
            @enderror
            ...
            <div class="mb-3 form-password-toggle">
                <label class="form-label" for="password">Password</label>
                <div class="input-group input-group-merge">
                  <input type="password" id="password" class="form-control" name="user_conf_password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
                  <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                </div>
              </div>
              @error('user_conf_password')
              <span class="alert alert-danger">{{ $message}}</span>
            @enderror
